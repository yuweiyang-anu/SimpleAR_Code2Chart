...
ACCELERATE_CPU_AFFINITY=1 \
 torchrun \
    ...
    --gen_data_path /openseg_blob/v-yuweiyang/SimpleAR/datasets/visual_tokens/code2chart_sft_1024_10_meta.json \
    --gen_image_folder "" \
    --token_dataset True \
    --sample_short True \
    ...
    --bf16 True \
    --run_name sft_code2chart_10_images \
    --output_dir /openseg_blob/v-yuweiyang/SimpleAR_Code2Chart/output_ckpt/code2chart_160k_for_sft_10_images/ \
