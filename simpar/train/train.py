...
# Construct the data:
# {
#   "code": "a list of integer tokens for visual feature",
#   "conversations": [
#     {"from": "human", "value": "caption"},
#     {"from": "gpt", "value": "<|vtokens|>"}
#   ]

# Process:
# input_ids: [BOS] caption [SEP] <|vtokens|> [EOS]
# labels:    [-100, -100, -100, -100, ..., label visual tokens..., -100]

# Prompt Input (caption only)
#     ↓
# Qwen2ForCausalLM backbone (<|vtokens|> → Visual Projector → Visual Embedding Tokens)
#     ↓
# Causal Language Modeling Head (linear)
#     ↓
# predict next visual token id
# logits size: (batch_size, seq_len, vocab_size)

# Overall Process:
# json data → LazySupervisedDataset / T2TokenDataset
#         ↓
